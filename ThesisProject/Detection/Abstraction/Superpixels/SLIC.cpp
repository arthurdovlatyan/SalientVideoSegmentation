...
Superpixels::SLIC::SLIC(cv::Mat img, 
	int region_size, 
	int ruler, 
...
cv::Mat Superpixels::SLIC::getResult() const
{
	return m_result;
}

cv::Mat Superpixels::SLIC::getMask() const
{
	return m_mask;
}
...
int Superpixels::SLIC::getNumber_of_superpixels() const
{
