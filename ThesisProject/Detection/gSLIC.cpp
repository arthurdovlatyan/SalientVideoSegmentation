...
void
slicSuperPixels(GPUAcceleration::OpenCL& opencl,
    ...
    GPUAcceleration::Memory& img, GPUAcceleration::Memory& clusterCenters, GPUAcceleration::Memory& clusterAssig)
{
    ...
    //GPUAcceleration::Memory clusterCenters(opencl, CL_MEM_READ_WRITE, sizeof(float) * clustersSize[0] * clustersSize[1] * 5);
    //GPUAcceleration::Memory clusterAssig(opencl, CL_MEM_READ_WRITE, sizeof(int) * imNPixels);
    //GPUAcceleration::Memory img(opencl, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, stride * imgSize.height, const_cast<float *>(img(0, 0)));
    ...
    // ================================
    GPUAcceleration::Kernel initClusterAssig(opencl, kernelSources, "initClusterAssig");
    ...
    {
        /*GPUAcceleration::TIMER("Initializing cluster assignment");*/
    ...
    // Run K-means
    // ================================
    GPUAcceleration::Kernel updateClusterCenters(opencl, kernelSources, "updateClusterCenters");
    ...
    GPUAcceleration::Kernel updateClusterAssignment(opencl, kernelSources, "updateClusterAssignment");
